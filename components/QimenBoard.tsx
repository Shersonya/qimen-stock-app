    ...
    >
      ...
      <div className="relative">
        ...
        <div className="mt-5 hidden sm:block" data-testid="qimen-desktop-layout">
          <div
            className="board-shell relative overflow-hidden rounded-[1.9rem] border border-[var(--border-soft)] p-4"
          ...
          >
            ...
            <div className="relative z-10 grid gap-3 [grid-template-columns:repeat(3,minmax(0,1fr))] [grid-template-rows:repeat(3,minmax(22rem,auto))]">
              {palaces.map((palace) => (
                <PalaceCard
        ...
        <div className="mt-4 hidden rounded-[1.4rem] border border-[var(--border-soft)] bg-[var(--surface-muted)] px-4 py-4 sm:block">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
